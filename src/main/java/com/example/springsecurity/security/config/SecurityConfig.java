...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                .csrf(csrf -> csrf.disable()) // CSRF qorumasını söndürmək üçün bu yazılış istifadə olunur// CORS-u aktiv edir
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/test/testAuth").hasAnyRole("ADMIN","USER")) // Qalan bütün URL-lərə autentifikasiya tələb edir
